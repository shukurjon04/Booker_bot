...
async def profile_region(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Endi tuman nomini kiriting:")
...
async def profile_district(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Oxirida — qishloq/mahalla nomini kiriting:")
...
def main():
    TOKEN = "8479466867:AAFa9DFzBh9XlsejIFm9yOLodPNBcuNLS0Y"
